# Cited from the THREE.js library: https://github.com/mrdoob/three.js/blob/master/utils/converters/obj/convert_obj_three.py
# Courtesy of http://stackoverflow.com/questions/15887736/how-to-convert-object-to-json-file-for-three-js-model-loader
# Run the following in terminal to convert an .obj to JSON format:
